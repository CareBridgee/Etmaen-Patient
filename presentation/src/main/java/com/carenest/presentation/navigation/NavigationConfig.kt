...
object NavigationConfig {
    ...
    val serializer = SerializersModule {
        polymorphic(NavKey::class) {
            ...
            serializableSubclass(AppRoute.History::class)
            ...
            serializableSubclass(AppRoute.ManualAddress::class)
            ...
            serializableSubclass(AppRoute.ServiceHistoryDetails::class)
            serializableSubclass(AppRoute.QrCode::class)
        }
    }
