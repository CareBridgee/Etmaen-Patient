    ...
    Column(
        ...
        WalletBalanceCard(
            ...
            autoRefillText = stringResource(
                R.string.wallet_balance_auto_refill,
                stringResource(if (state.isAutoRefillEnabled) R.string.wallet_on else R.string.wallet_off)
            ),
        ...
        Surface(
            ...
            WalletActionRow(
                ...
                icon = painterResource(DR.drawable.ic_payment_method),
        ...
        Surface(
            ...
            Column {
                WalletActionRow(
                    ...
                    icon = painterResource(DR.drawable.ic_profile),
                    selected = true,
                    showChevron = false
                )
                WalletActionRow(
                    ...
                    painterResource(DR.drawable.ic_work)
                )
            }
        }
    }
