...
fun AddPaymentMethodScreen(
    ...
    Column(
            ...
            Column {
                val options = listOf(
                    Triple(
                        ...
                        DR.drawable.ic_payment_method,
                        onCreditCardClick
                    ),
                    Triple(R.string.wallet_paypal, DR.drawable.ic_bank, onPayPalClick),
                    Triple(R.string.wallet_fawry_cash, DR.drawable.ic_wallet, onFawryCashClick),
                    Triple(R.string.wallet_meeza_card, DR.drawable.paymob_filled, onMeezaCardClick),
                    Triple(
                        R.string.wallet_mobile_wallets,
                        DR.drawable.ic_phone,
                        onMobileWalletClick
                    ),
                )
        ...
        Row(
            ...
            Icon(
                painterResource(DR.drawable.ic_verified),
                null,
            ...
            Text(
                stringResource(R.string.wallet_secure_payments),
...
@Preview
@Composable
private fun AddPaymentPreview() = SpTheme { AddPaymentMethodScreen({}, {}, {}, {}, {}) }
