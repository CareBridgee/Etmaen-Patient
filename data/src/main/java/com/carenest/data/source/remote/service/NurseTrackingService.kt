...
interface NurseTrackingService {
    ...
    suspend fun fetchCurrentServiceRequest(): Result<ServiceRequestTrackingDto>
    ...
    suspend fun getNurseOffers(serviceRequestId: String): Result<List<NurseOfferResponseDto>>
}