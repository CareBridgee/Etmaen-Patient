...
interface AuthDatasource {
    ...
    suspend fun loginWithGoogle(idToken: String): Result<GoogleAuthResponseDto>
    suspend fun requestDevOtp(phoneNumber: String): Result<LoginResponse>
    suspend fun verifyOtp(phoneNumber: String, otp: String, pendingToken: String? = null): Result<AuthResponse>
